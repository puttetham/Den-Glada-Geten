...
<body>
    <div id="container">
        ...
        <section id="start-gallery">
            <div class="slideshow">
              <img class="mySlides" src="images/1.jpg" style="height:100%">
              <img class="mySlides" src="images/2.jpg" style="height:100%">
              <img class="mySlides" src="images/3.jpg" style="height:100%">
            </div>
        </section>
